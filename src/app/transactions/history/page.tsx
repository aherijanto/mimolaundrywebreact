  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 w-full">
      <div className="flex items-start">
        <h1 className="text-2xl font-bold m-8 text-blue-600">Transaction History</h1>
      </div>
                  ...
                  <tbody>
                    {transactions.map((t, idx) => (
                      <tr key={t.id} className="odd:bg-white even:bg-gray-50 transition hover:bg-blue-50">
                        ...
                        <td className="px-3 py-2 text-center text-blue-600 font-semibold">{t.payment_status ? "Paid" : "Unpaid"}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
